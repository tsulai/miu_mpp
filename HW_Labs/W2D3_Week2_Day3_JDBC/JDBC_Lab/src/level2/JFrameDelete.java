...
public class JFrameDelete extends JFrame implements ActionListener {
	...
	JFrameDelete(){
		...
		this.setTitle("Delete Student Info");
		...
		lblStudentID.setText("Enter Student ID that you want to delete(xxx-xxx)");		
		...
		btnSubmit.addActionListener(evt -> {				
				...
				//System.out.println("Student ID " + txtStudentID.getText() + " is successfully deleted.");
	...
	public static void main(String[] args) {
		...
		JFrameDelete form1 = new JFrameDelete();
