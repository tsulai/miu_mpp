...
public class Main {
	...
	public static void main(String[] args) {
		...
		ACustomer john = new CorporateCust("John", "1000 N 4th St, Fairfield IA 52557", "641-819-2000", 25,5000.00);
		ACustomer mary = new PersonalCust("Mary", "5 St.Micheal Ave, Brooklyn NY 72597", "641-819-2002", 0,"1234567890123456");
		...
		Order mOrder1 = new Order("000-000-453", LocalDate.of(2021, 12, 10), "Shipped", mary);
	...
	public static void printOrder(Order ord) {
