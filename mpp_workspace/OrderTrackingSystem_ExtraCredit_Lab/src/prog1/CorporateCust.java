...
public class CorporateCust extends ACustomer {
	...
	//have to record like screenshot for bill generating, if not after points have been deducted for discount, retrieving bill from order obj and customer obj again will not reflect the actual amount paid during transaction
