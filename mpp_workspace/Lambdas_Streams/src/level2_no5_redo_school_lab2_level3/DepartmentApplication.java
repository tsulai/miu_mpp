...
However, this mistake below does show us How we could implement the code IF it was two-directional!  */
      ...
      //dept.showAllStudentsOfAFacultyMember("John Doodle");
      ...
      while(true)
         ...
         putText("getTotalSalary, showAllMembers, unitsPerFaculty, allStudentsOfAFacultyMember or quit : ");
         int choice = getChar();
         switch(choice)
            {
            case 'g':
            ...
            case 'u':
               ...
               break;
            case 'a':
            	putText("Enter the name of the faculty member: ");
            	dept.showAllStudentsOfAFacultyMember(getString());
            	putText("\n");
            	break;
            case 'q': return;
            default:
