...
public 	class Employee implements Cloneable {
	...
	public Employee(int id, String fn, String mi, String ln, int yearOfBirth, int monthOfBirth, int dayOfBirth, String ssn, double sal, Date dob)
	{
		this.employeeId = id;
		this.firstName = fn;
